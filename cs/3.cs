...
class CheckStrings: Task{
    public void Same(string? A, string? B){
        ...
        if(A == B){
            Console.WriteLine(" ");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 20)));
            Console.WriteLine($"\nIt's same strings. {A} == {B}");
            Console.WriteLine(" ");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 20)));
        }
        else if(ANotSpaceLow == BNotSpaceLow){
            Console.WriteLine(" ");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 20)));
            Console.WriteLine($"\nIt's same strings not space and in low register. {ANotSpaceLow} == {BNotSpaceLow}");
            Console.WriteLine(" ");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 20)));
        }
        else if(ARevNotSpaceLow == BNotSpaceLow){
            Console.WriteLine(" ");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 20)));
            Console.WriteLine($"\nIt's REVERSE strings. {ARevNotSpaceLow} == {BNotSpaceLow}");
            Console.WriteLine(" ");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 20)));
        }
        else{
